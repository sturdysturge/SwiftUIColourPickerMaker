...
public extension ColourDataBindable where ValueType == ColourModel.RGBAValues {
...
public extension ColourDataBindable where ValueType == ColourModel.HSBAValues {
  func getBackground() -> Color {
    let parameterArray = [parameters.0, parameters.1]
...
public extension ColourDataBindable where ValueType == ColourModel.CMYKAValues {
  func getBackground() -> Color {
    let parameterArray = [parameters.0, parameters.1]
...
extension ColourDataBindable where ValueType == ColourModel.GreyscaleValues {
  public func getBackground() -> Color {
    return .clear
  }
  
  public func bindingValues() -> (x: Binding<Double>, y: Binding<Double>) {
