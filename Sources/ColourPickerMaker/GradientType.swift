...
public enum GradientType {
    ...
    static func brightness(hue: Double, saturation _: Double, startPoint: UnitPoint) -> LinearGradient {
    ...
    static func saturation(hue: Double, brightness _: Double, startPoint: UnitPoint) -> LinearGradient {
    ...
    var horizontal: LinearGradient { LinearGradient(gradient: gradient, startPoint: .leading, endPoint: .trailing) }

    var vertical: LinearGradient { LinearGradient(gradient: gradient, startPoint: .top, endPoint: .bottom) }

    var diagonal: LinearGradient { LinearGradient(gradient: gradient, startPoint: .topLeading, endPoint: .bottomTrailing) }
}
